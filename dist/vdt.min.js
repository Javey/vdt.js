...
},trimRight:function(e){var t=e.length;while(t--&&u.isWhiteSpace(e.charCodeAt(t))){}return e.slice(0,t+1)},Type:i,TypeName:o,isSelfClosingTag:function(e){return s[e]}};t.exports=u},{}],52:[function(e,t,n){var r=new(e("./parser")),i=new(e("./stringifier")),o=e("virtual-dom"),s=e("dom-delegator");var a=new s;var u=function(e,t){var n,r,i,s;n=f(e,t);return{render:function(e,t){s=t;this.data=e;r=n.call(s,this.data,u);i=o.create(r);return i},update:function(e,t){if(arguments.length){this.data=e;if(arguments.length>1){s=t}}var a=n.call(s,this.data,u),f=o.diff(r,a);i=o.patch(i,f);r=a;return i},data:{},getTree:function(){return r},setTree:function(e){r=e},getNode:function(){return i},setNode:function(e){i=e}}};function f(e,t){var n;switch(typeof e){case"string":var o=r.parse(e),s=i.stringify(o,t);s="var h = Vdt.virtualDom.h;\nwith(obj || {}) {"+s+"};";n=new Function("obj","Vdt",s);n.source="function(obj, Vdt) {\n"+s+"\n}";break;case"function":n=e;break;default:throw new Error("Expect a string or function")}return n}u.parser=r;u.stringifier=i;u.virtualDom=o;u.compile=f;u.delegator=a;t.exports=u},{"./parser":49,"./stringifier":50,"dom-delegator":3,"virtual-dom":18}],53:[function(e,t,n){},{}],54:[function(e,t,n){t.exports=e("./lib/vdt")},{"./lib/vdt":52}]},{},[54])(54)});